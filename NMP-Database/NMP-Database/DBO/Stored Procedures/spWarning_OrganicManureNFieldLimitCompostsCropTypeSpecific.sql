...
BEGIN
    ...
    -------------------------------------------------------------------------
    -- 2) LOAD CROP FROM MANAGEMENT PERIOD
    -------------------------------------------------------------------------
    ...
    -------------------------------------------------------------------------
    -- 9) TOTAL N FOR GREEN COMPOST ON ALLOWED CROPS OVER 4 YEARS
    -------------------------------------------------------------------------
    SELECT
        @TotalOrganicManureN = ISNULL(SUM(om.N), 0)
    FROM OrganicManures om
    ...
    SELECT
        ...
        @IsTotalNAbove1000 AS IsTotalNAbove1000;
