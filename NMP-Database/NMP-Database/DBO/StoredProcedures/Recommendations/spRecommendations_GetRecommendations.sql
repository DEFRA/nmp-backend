...
BEGIN
    ...
    SELECT
		...
		[Crops].[SwardTypeID] AS Crop_SwardTypeID,
		[Crops].[SwardManagementID] AS Crop_SwardManagementID,
		[Crops].[PotentialCut] AS Crop_PotentialCut,
		[Crops].[CropGroupName] AS Crop_CropGroupName,
        ...
        [Recommendations].[SBalance] AS Recommendation_SBalance,
