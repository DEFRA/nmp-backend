CREATE PROCEDURE [dbo].[spFertiliserManures_GetByFarmIdAndYear]
	...
	@harvestYear int
AS
	SELECT fi.id ID,fi.[Name] [Name],CONVERT(DATE,fert.ApplicationDate) ApplicationDate,
	fert.N Nitrogen,fert.P2O5 P2O5,fert.MgO MgO,fert.K2O K2O, fert.Lime Lime,fert.SO3 SO3
