...
You can check your compliance with the N-max limit for all fields growing this crop by producing an N-max report.', N'It is an offence to breach the Nitrate Vulnerable Zone rules, and you should consider reducing the amount inorganic fertiliser nitrogen and crop-available nitrogen from organic manures you apply.',6,0)
    ...
    INSERT [dbo].[Warnings] ([ID], [WarningKey], [CountryID], [Header], [Para1], [Para2], [Para3], [WarningCodeID], [WarningLevelID]) VALUES (44, N'NMAXLIMIT', 3, N'Maximum nitrogen limits', N'This application may take you over the maximum nitrogen limit for this crop', N'The Water Resources Regulations include a limit on the average amount of inorganic fertiliser nitrogen and crop-available nitrogen from organic manure that you can apply to most crops each year - this is known as the maximum nitrogen limit.
...
BEGIN
    UPDATE dbo.Warnings
SET [Para2] = 'The Nitrate Vulnerable Zone rules include a limit on the average amount of inorganic fertiliser nitrogen and crop-available nitrogen from organic manure that you can apply to most crops each year - this is known as the N-max limit.
...
BEGIN
    UPDATE dbo.Warnings
SET [Para2] = 'The Water Resources Regulations include a limit on the average amount of inorganic fertiliser nitrogen and crop-available nitrogen from organic manure that you can apply to most crops each year - this is known as the maximum nitrogen limit.
