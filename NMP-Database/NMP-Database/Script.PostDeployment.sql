...
You can check your compliance with the N-max limit for all fields growing this crop by producing an N-max report.', N'It is an offence to breach the Nitrate Vulnerable Zone rules, and you should consider reducing the amount inorganic fertiliser nitrogen and crop-available nitrogen from organic manures you apply.',6,0)
    INSERT [dbo].[Warnings] ([ID], [WarningKey], [CountryID], [Header], [Para1], [Para2], [Para3], [WarningCodeID], [WarningLevelID]) VALUES (5, N'HIGHNORGANICMANURECLOSEDPERIOD', 1, @HEADER_ORGANIC, N'The application date you entered is inside your closed spreading period for applying high readily available nitrogen organic manure', NULL, @NVZ_OFFENCE_DATE,1,1)
    ...
    INSERT [dbo].[Warnings] ([ID], [WarningKey], [CountryID], [Header], [Para1], [Para2], [Para3], [WarningCodeID], [WarningLevelID]) VALUES (30, N'NITROFERTCLOSEDPERIOD', 2, N'Closed period for the application of manufactured nitrogen fertilisers.', N'The application date you entered is inside your closed spreading period for applying inorganic nitrogen fertiliser', NULL, @NVZ_OFFENCE_DATE, 5, 2)
